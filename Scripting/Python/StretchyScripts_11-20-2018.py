...
#-----------------------------------------------------------------------------------------------
def RStretchyIK(ctrlName='stretchy'):
    ...
    cmds.ikHandle(name='stretchyIKHandle', sj=sels[2], ee=sels[-1], solver='ikRPsolver')
    
    cmds.parent('stretchyIKHandle', sels[1])
...
def LStretchyIK(ctrlName='stretchy'):
    sels = cmds.ls(sl=True)
